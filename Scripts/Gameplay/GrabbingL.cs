...
public class GrabbingL : MonoBehaviour 
{
	...
	void Update () 
	{
		if (OVRInput.Get (OVRInput.Button.PrimaryHandTrigger)) GrabObject();
		if (!OVRInput.Get(OVRInput.Button.PrimaryHandTrigger)) DropObject();
	}
}